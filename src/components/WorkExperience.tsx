...
const experiences = [
    {
       ...
       description: 'Developing digital infrastructure for climate markets, carbon finance and Article 6 implementation.',
   ...
   },
    {
        ...
        location: 'Kandy, SL',
        description: 'Designing and delivering scalable software solutions for global clients.',
            ...
            <div className="work-header">
                <div className="work-header-top">
                    <div className="work-header-left">
                        ...
                        <h2 className="work-heading">Explore My Work<br />Journey</h2>
                    </div>
                    <div className="work-header-right">
                        <p className="work-intro-text">
                            Over the past 2+ years, I've had the opportunity to work on a wide range of projects, collaborating with diverse teams and clients to deliver innovative software solutions.
                        </p>
                        <a href="#contact" className="work-cta-link">Schedule a Call ↗</a>
                    </div>
                </div>
            </div>
                    ...
                    <div key={exp.id} className="work-item">
                        <div className="work-item-left">
                            <div className="work-company-info">
                                <h3 className="work-company-name">{exp.company}, {exp.location}</h3>
                        ...
                        <div className="work-item-right">
                            {exp.skills.map((skill, idx) => (
                                <span key={idx} className="work-skill-badge">{skill}</span>
                            ))}
                        </div>
                    </div>
                ))}
