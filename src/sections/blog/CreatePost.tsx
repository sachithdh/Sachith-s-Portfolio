...
export default function CreatePost() {
    ...
    const handlePublish = async () => {
        try {
            ...
            const postData = {
                title,
                excerpt: excerpt.trim() || content.replace(/^#+\s+.*$/m, "").replace(/[*_`#>-]/g, "").trim().substring(0, 200) + "…",
                content,
                        ...
                        <div className="cp-publish-modal__summary">
                            ...
                            {excerpt.trim() && (
                                <div className="cp-publish-summary-item">
                                    ...
                                    <span className="cp-publish-summary-value" style={{ fontStyle: "italic", opacity: 0.85 }}>{excerpt.trim()}</span>
                                </div>
                            )}
                            <div className="cp-publish-summary-item">
